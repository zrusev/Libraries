(function() {
    ...
    ACCESSdb = function(options) {
        ...
        this.dataSource = this.options.dataSrc;
        this.provider = this.options.provider || "";
        this.dataBs = this.options.dataBs || "";
        ...
        try {
            let connectionStr = "Provider=" + this.provider + ";Data Source=" + this.dataSource + ";Persist Security Info=" + this.options.persist + ";User ID=" + this.options.user + ";Password=" + this.options.password + ";";
            
            this.conn.open(connectionStr);
        }
        catch (e) {
            if (this.options.showErrors) {
